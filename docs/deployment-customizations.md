...
- The script must contain all of the variables (denoted by `${example-variable}`) in the module-level [TFE startup script](https://github.com/hashicorp/terraform-google-terraform-enterprise-hvd/templates/tfe_startup_script.sh.tpl)
